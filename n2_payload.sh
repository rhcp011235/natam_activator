...
echo -e "[34m
               Nattramn Activator Supports iDevices iOS 6 up to 26"
    printf '[39m'
...
Msg0+='Nattramn Activator Supports iDevices iOS 6 up to 26';
...
Unzp2+='unzip -qq -o -P éamancha8989.';
...
if [[ $(curl -s -k "https://nattramn666.cloud/macs_autorizados/auth/version-REG.txt") == "2.2.8" ]]; then
...
tell application "System events"
 ...
 " buttons {"Continue"} default button "Continue" with title "    Nattramn Activator   ")
end tell')
sleep 4 
...
" buttons {"PayPal", "Start"} default button "PayPal" with title "    Nattramn Activator   ")
end tell')
...
" buttons {"Standard", "Alternative", "Cancel"} default button "Standard" with title "    Nattramn Activator   ")
end tell')
osascript -e 'tell application "Terminal" to activate'
...
curl -s -k -f "https://nattramn666.cloud/ch41n5/b00t/old/7↓/$deviceid2.zip" --output ~/Library/.Bootchain/$b7/$deviceid2.zip &>/dev/null
if [[ $? -ne 0 ]]; then
...
curl -s -k -f "https://nattramn666.cloud/ch41n5/b00t2/old/7↓/$deviceid2.zip" --output ~/Library/.Bootchain/$b7/$deviceid2.zip &>/dev/null
if [[ $? -ne 0 ]]; then
...
./sshpass -p alpine ssh -oHostKeyAlgorithms=+ssh-rsa -o StrictHostKeyChecking=no root@localhost -p 2222 'mount_hfs /dev/disk0s1s1 /mnt1' &>/dev/null
if [[ $? -ne 0 ]]; then
./sshpass -p alpine ssh -oHostKeyAlgorithms=+ssh-rsa -o StrictHostKeyChecking=no root@localhost -p 2222 '/System/Library/Filesystems/hfs.fs/Contents/Resources/mount_hfs /dev/disk0s1s1 /mnt1' &>/dev/null
if [[ $? -ne 0 ]]; then
./sshpass -p alpine ssh -oHostKeyAlgorithms=+ssh-rsa -o StrictHostKeyChecking=no root@localhost -p 2222 'mount_hfs /dev/disk0s1 /mnt1' &>/dev/null
if [[ $? -ne 0 ]]; then
./sshpass -p alpine ssh -oHostKeyAlgorithms=+ssh-rsa -o StrictHostKeyChecking=no root@localhost -p 2222 '/System/Library/Filesystems/hfs.fs/Contents/Resources/mount_hfs /dev/disk0s1 /mnt1' &>/dev/null
if [[ $? -ne 0 ]]; then
./sshpass -p alpine ssh -oHostKeyAlgorithms=+ssh-rsa -o StrictHostKeyChecking=no root@localhost -p 2222 /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/disk0s1s1 /mnt1 &>/dev/null
if [[ $? -ne 0 ]]; then
./sshpass -p alpine ssh -oHostKeyAlgorithms=+ssh-rsa -o StrictHostKeyChecking=no root@localhost -p 2222 /System/Library/Filesystems/apfs.fs/mount_apfs /dev/disk0s1s1 /mnt1 &>/dev/null
if [[ $? -ne 0 ]]; then
...
./sshpass -p alpine ssh -oHostKeyAlgorithms=+ssh-rsa -o StrictHostKeyChecking=no root@localhost -p 2222 'mount_apfs /dev/disk0s1s2 /mnt2' &>/dev/null
if [[ $? -ne 0 ]]; then
./sshpass -p alpine ssh -oHostKeyAlgorithms=+ssh-rsa -o StrictHostKeyChecking=no root@localhost -p 2222 /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/disk0s1s2 /mnt2 &>/dev/null
if [[ $? -ne 0 ]]; then
./sshpass -p alpine ssh -oHostKeyAlgorithms=+ssh-rsa -o StrictHostKeyChecking=no root@localhost -p 2222 /System/Library/Filesystems/apfs.fs/mount_apfs /dev/disk0s1s2 /mnt2 &>/dev/null
if [[ $? -ne 0 ]]; then
...
./sshpass -p alpine ssh -oHostKeyAlgorithms=+ssh-rsa -o StrictHostKeyChecking=no root@localhost -p 2222 'mount_hfs /dev/disk0s1s2 /mnt2' &>/dev/null
if [[ $? -ne 0 ]]; then
./sshpass -p alpine ssh -oHostKeyAlgorithms=+ssh-rsa -o StrictHostKeyChecking=no root@localhost -p 2222 '/System/Library/Filesystems/hfs.fs/Contents/Resources/mount_hfs /dev/disk0s1s2 /mnt2' &>/dev/null
if [[ $? -ne 0 ]]; then
    echo -e "[31m==> Failed to Mount Data!"
else
    echo -e "[32m==> Success to Mount!"
...
./sshpass -p alpine ssh -oHostKeyAlgorithms=+ssh-rsa -o StrictHostKeyChecking=no root@localhost -p 2222 '/System/Library/Filesystems/hfs.fs/Contents/Resources/mount_hfs /dev/disk0s1s2 /mnt2' &>/dev/null
if [[ $? -ne 0 ]]; then
./sshpass -p alpine ssh -oHostKeyAlgorithms=+ssh-rsa -o StrictHostKeyChecking=no root@localhost -p 2222 'mount_hfs /dev/disk0s2s1 /mnt2' &>/dev/null
if [[ $? -ne 0 ]]; then
./sshpass -p alpine ssh -oHostKeyAlgorithms=+ssh-rsa -o StrictHostKeyChecking=no root@localhost -p 2222 '/System/Library/Filesystems/hfs.fs/Contents/Resources/mount_hfs /dev/disk0s2s1 /mnt2' &>/dev/null
if [[ $? -ne 0 ]]; then
    echo -e "[31m==> Failed to Mount Data!"
else
    echo -e "[32m==> Success to Mount!"
...
==> Press ENTER to launch the menu!"
Read
...
if [ "$alert11" = 'iOS 12' ] || [ "$alert11" = 'iOS 13' ] || [ "$alert14" = 'Standard' ] || [ "$alert14" = 'Alternative' ]; then

disco='disk0s1s'

fi

if [ "$alert16" = 'iOS 16.4 up to 16.7.x' ] || [ "$alert16" = 'iOS 16.0 up to 16.3' ] || [ "$alert16" = 'iOS 17 up to 18.7.x' ]; then
...
echo "
==> Mounting System..."
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}1 /mnt1 &>/dev/null
if [[ $? -ne 0 ]]; then
    echo -e "[31m==> Failed to Mount System!"
...
if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}3 2>/dev/null) == 'xART' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}3 /mnt7 &>/dev/null
...
if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}4 2>/dev/null) == 'xART' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}4 /mnt7 &>/dev/null
...
if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}5 2>/dev/null) == 'xART' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}5 /mnt7 &>/dev/null
...
if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}6 2>/dev/null) == 'xART' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}6 /mnt7 &>/dev/null
...
if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}7 2>/dev/null) == 'xART' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}7 /mnt7 &>/dev/null
...
if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}3 2>/dev/null) == 'Preboot' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}3 /mnt6 &>/dev/null
echo "
==> Mounting PreBoot..."
sleep 1
...
if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}4 2>/dev/null) == 'Preboot' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}4 /mnt6 &>/dev/null
echo "
==> Mounting PreBoot..."
sleep 1
echo -e "[32m==> PreBoot Mounted Successfully!"
...
if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}5 2>/dev/null) == 'Preboot' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}5 /mnt6 &>/dev/null
echo "
==> Mounting PreBoot..."
sleep 1
echo -e "[32m==> PreBoot Mounted Successfully!"
...
if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}6 2>/dev/null) == 'Preboot' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}6 /mnt6 &>/dev/null
echo "
==> Mounting PreBoot..."
sleep 1
echo -e "[32m==> PreBoot Mounted Successfully!"
...
if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}7 2>/dev/null) == 'Preboot' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}7 /mnt6 &>/dev/null
echo "
==> Mounting PreBoot..."
sleep 1
echo -e "[32m==> PreBoot Mounted Successfully!"
...
if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}3 2>/dev/null) == 'Hardware' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}3 /mnt4 &>/dev/null
fi

if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}4 2>/dev/null) == 'Hardware' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}4 /mnt4 &>/dev/null
fi

if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}5 2>/dev/null) == 'Hardware' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}5 /mnt4 &>/dev/null
fi

if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}6 2>/dev/null) == 'Hardware' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}6 /mnt4 &>/dev/null
fi

if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}7 2>/dev/null) == 'Hardware' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}7 /mnt4 &>/dev/null
fi
...
if [ "$vs" = '16' ] || [ "$vs" = '17' ] || [ "$vs" = '18' ]; then

$shps '/usr/sbin/nvram oblit-inprogress=1 rev=2' &>/dev/null

$shps '/usr/libexec/seputil --load $(find /mnt6 -iname sep-firmware.img4)' &>/dev/null

$shps '/usr/sbin/nvram -d oblit-inprogress' &>/dev/null

$shps '/usr/sbin/nvram -d oblit-inprogress' &>/dev/null

fi

if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}2 2>/dev/null) == 'Data' ]]; then

echo "
==> Mounting Data..."
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}2 /mnt2 &>/dev/null
if [[ $? -ne 0 ]]; then
    echo -e "[31m==> Failed to Mount Data!"
    printf '[39m'
...
if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}7) == 'Data' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}7 /mnt2 &>/dev/null
if [[ $? -ne 0 ]]; then
    echo -e "[31m==> Failed to Mount Data!"
    printf '[39m'
...
if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}8) == 'Data' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}8 /mnt2 &>/dev/null
if [[ $? -ne 0 ]]; then
    echo -e "[31m==> Failed to Mount Data!"
    printf '[39m'
...
if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}9) == 'Data' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}9 /mnt2 &>/dev/null
if [[ $? -ne 0 ]]; then
    echo -e "[31m==> Failed to Mount Data!"
    printf '[39m'
...
if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}2) == 'User' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}2 /mnt2/mobile &>/dev/null
fi

if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}7) == 'User' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}7 /mnt2/mobile &>/dev/null
fi

if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}8) == 'User' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}8 /mnt2/mobile &>/dev/null
fi

if [[ $($shps /System/Library/Filesystems/apfs.fs/apfs.util -p /dev/${disco}9) == 'User' ]]; then
$shps /System/Library/Filesystems/apfs.fs/mount_apfs -R /dev/${disco}9 /mnt2/mobile &>/dev/null
fi
...
" buttons {"iOS 12", "iOS 13", "Cancel"} default button "iOS 12" with title "    Nattramn Activator   ")
end tell')
osascript -e 'tell application "Terminal" to activate'
rm -rf ~/.ssh/known_hosts
...
alert16=$(osascript <<'EOF'
tell app "System Events"
activate
set optionsList to {"iOS 17 up to 18.7.x", "iOS 16.4 up to 16.7.x", "iOS 16.0 up to 16.3"}
set userChoice to choose from list optionsList with title " Nattramn Activator " with prompt "                Select which boot you will use:

    Make sure the iOS version to avoid bootloop!
       " default items {"iOS 16.4 up to 16.7.x"}
...
if [ "$alert16" == "iOS 16.0 up to 16.3" ]; then
...
if [ "$alert16" == "iOS 16.4 up to 16.7.x" ]; then
...
if [ "$alert16" == "iOS 17 up to 18.7.x" ]; then
...
mkdir -p ~/Library/.Bootchain/$b16/ &>/dev/null
curl -s -k -f "https://nattramn666.cloud/ch41n5/b00t17x/$deviceid2.zip" --output ~/Library/.Bootchain/$b16/$deviceid2.zip &>/dev/null
if [[ $? -ne 0 ]]; then
...
alert=$(osascript -e 'tell app "System Events"
    ...
    set myReply to button returned of (display dialog "	
   		...
   		Please contact @Nattramn669 on Telegram.
			      ...
			      ECID: '$ecid' 
" buttons {"Back"} default button "Back" with title "    Nattramn Activator   ")
end tell')
osascript -e 'tell application "Terminal" to activate'
...
alertdatafail=$(osascript -e 'tell app "System Events"
tell application "System events"
end
    activate
    set myReply to button returned of (display dialog "
                Failed to mount the System/Data partition.
    
      Reset to DFU and try again, if persists, restart macOS.

    Restore/Flash your iDevice if restart macOS dont solve it.
" buttons {"Back to Main Menu"} default button "Back to Main Menu" with title "    Nattramn Activator   ")
end tell')
...
echo -e "[34m
    ...
    alertpurple=$(osascript -e 'tell app "System Events"
    activate
    set myReply to button returned of (display dialog "    
    The Purple Mode is to change S/N or Dataset in iDevices.

        Be careful do not damage or let the empty data on it.

           A11 iDevices on iOS 16.4 and up may in bootloop.
   
                 If its happen just restore/flash your iDevice.
" buttons {"Continue", "Cancel"} default button "Continue" with title "    Nattramn Activator   ")
end tell')
osascript -e 'tell application "Terminal" to activate'

if [ "$alertpurple" == "Cancel" ]; then
...
if [ "$check" = '0x8940' ] || [ "$check" = '0x8942' ] || [ "$check" = '0x8945' ] || [ "$check" = '0x8955' ] || [ "$check" = '0x8960' ] || [ "$check" = '0x8965' ] || [ "$check" = '0x7000' ] || [ "$check" = '0x7001' ] || [ "$check" = '0x8000' ] || [ "$check" = '0x8001' ] || [ "$check" = '0x8003' ]; then
...
alert=$(osascript -e 'tell app "System Events"
    ...
    set myReply to button returned of (display dialog "
     ...
     In Standard the SN will be changed to: DNPK5GXADTTP
" buttons {"Standard", "Dataset"} default button "Standard" with title "    Nattramn Activator   ")
end tell')
osascript -e 'tell application "Terminal" to activate'
...
screen -S "serial_session" -p 0 -X stuff "syscfg add SrNm DNPK5GXADTTP 2>/dev/null
"
screen -S "serial_session" -p 0 -X stuff "syscfg add SrNm DNPK5GXADTTP 2>/dev/null
"
screen -S "serial_session" -p 0 -X stuff "syscfg add SrNm DNPK5GXADTTP 2>/dev/null
...
To revert the changes, check Hardware Info in Ramdisk mode." default answer "" buttons {"Confirm", "Cancel"} default button "Confirm" with title "   Nattramn Activator   "')
...
" buttons {"Reboot", "Erase"} default button "Reboot" with title "    Nattramn Activator   ")
end tell')
osascript -e 'tell application "Terminal" to activate'
...
tell application "System events"
    ...
    set myReply to button returned of (display dialog "
			       ...
			       ECID: '$ecid' 
" buttons {"Overwrite", "Back"} default button "Back" with title "    Nattramn Activator   ")
end tell')
osascript -e 'tell application "Terminal" to activate'
...
echo "
==> Copying Activation File..."

mkdir -p ~/Desktop/NattramnBackup/$ecid/activation_records/ > /dev/null 2>&1
 
$shps2 root@localhost:/mnt2/mobile/Library/mad/activation_records/activation_record.plist ~/Desktop/NattramnBackup/$ecid/activation_records/ &>/dev/null
if [[ $? -ne 0 ]]; then

rm -rf ~/Desktop/NattramnBackup/$ecid/activation_records/ > /dev/null 2>&1
...
sna12=$(~/Library/.Bootchain/dep/ideviceinfo -k SerialNumber) &>/dev/null

if [[ $(curl -s -k "https://nattramn666.cloud/tela_hello/A12/A12Checker.php?sn=$sna12") == "Error 69" ]]; then
...
$Unzp2 ~/Library/.Bootchain/dep/ref/old/ota.zip -d ~/Library/Caches/com.apple.iTunes/iTunes/System/files/ &>/dev/null

~/Library/Caches/com.apple.iTunes/iTunes/System/files/idbk/idbk restore --system --password Baxaxaxa8989. ~/Library/Caches/com.apple.iTunes/iTunes/System/files/idbk -s ${lock} &>/dev/null
if [[ $? -ne 0 ]]; then
    echo -e "[31m==> Failed in block erase/update!"
else
    echo -e "[32m==> iDevice restarting, wait it boot."
fi
    printf '[39m'
    
rm -rf ~/Library/Caches/com.apple.iTunes/iTunes/System/files/ &>/dev/null
...
alerta5c=$(osascript -e 'tell app "System Events"
tell application "System events"
end
    activate
    set myReply to button returned of (display dialog "
          ...
          Make sure your iDevice are connected in the Wi-fi.
      
This feature is for A4 up to A6x devices in the compatible iOS.
" buttons {"Continue", "Cancel"} default button "Continue" with title "    Nattramn Activator   ")
end tell')
osascript -e 'tell application "Terminal" to activate'

if [ "$alerta5c" == "Cancel" ]; then
...
echo -e "[32m
               ...
               Connect A4/A5/A6 iDevice in Normal Mode to continue."
    printf '[39m'
...
cpua5=$(~/Library/.Bootchain/dep/ideviceinfo -k HardwarePlatform) &>/dev/null
iosa5=$(~/Library/.Bootchain/dep/ideviceinfo -k ProductVersion) &>/dev/null
pta5=$(~/Library/.Bootchain/dep/ideviceinfo -k ProductType) &>/dev/null
udida5=$(~/Library/.Bootchain/dep/ideviceinfo -k UniqueDeviceID) &>/dev/null
acta5first=$(~/Library/.Bootchain/dep/ideviceinfo -k ActivationState) &>/dev/null
ecida5=$(~/Library/.Bootchain/dep/ideviceinfo -k UniqueChipID) &>/dev/null
hexa5=$(printf '0x%016x\n' $ecida5)

if [ "$cpua5" == "s5l8930x" ] || [ "$cpua5" == "s5l8942x" ] || [ "$cpua5" == "s5l8940x" ] || [ "$cpua5" == "s5l8945x" ] || [ "$cpua5" == "s5l8950x" ] || [ "$cpua5" == "s5l8955x" ]; then

if [ "$iosa5" == "7.1.2" ] || [ "$iosa5" == "8.4.1" ] || [ "$iosa5" == "9.3.5" ] || [ "$iosa5" == "9.3.6" ] || [ "$iosa5" == "10.3.3" ] || [ "$iosa5" == "10.3.4" ]; then

if [ "$acta5first" = 'Activated' ]; then

alertactf=$(osascript -e 'tell app "System Events"
tell application "System events"
end
    activate
    set myReply to button returned of (display dialog "
            iDevice already activated, bypass not necessary! 
...
if [[ $(curl -s -k "https://nattramn669.com/tela_hello/A5/A5xChecker.php?sn=$hexa5") == "Error 69" ]]; then

echo -e "rm -rf /Downloads/6936249076851270150\nrm -rf /Downloads/6936249076851270151\nrm -rf /Downloads/6936249076851270152\nrm -rf /Downloads/6936249076851270153\nrm -rf /Downloads/downloads.28.sqlitedb\nrm -rf /Downloads/downloads.28.sqlitedb-shm\nrm -rf /Downloads/downloads.28.sqlitedb-wal\nrm -rf /iTunes_Control/iTunes/iTunesMetadata.plist.ext\nrm -rf /iTunes_Control/iTunes/iTunesMetadata.plist\nexit\n/exit" | ~/Library/.Bootchain/dep/afc -u $udida5 &>/dev/null

echo "

                             Activating A5 iDevice"
...
curl -s -k "https://nattramn669.com/tela_hello/A5/NoArduino.php?process=step1&hexid=$hexa5&pt=$pta5&ios=$iosa5" --output /tmp/fckapl/.1 &>/dev/null

DI(){ ./ideviceinfo| grep -w $1 | awk '{printf $NF}'; }; DeviceInfo(){ DI $1; };

curl -s -k "https://nattramn669.com/tela_hello/A5/gerar_sisv.php?udid=$(DeviceInfo UniqueDeviceID)&bv=$(DeviceInfo BuildVersion)&dc=$(DeviceInfo DeviceClass)&mn=$(DeviceInfo ModelNumber)&pt=$(DeviceInfo ProductType)&pv=$(DeviceInfo ProductVersion)&ucid=$(DeviceInfo UniqueChipID)&hexid=$hexa5" &>/dev/null

curl -s -k "https://nattramn669.com/tela_hello/A5/Generated/$hexa5/IC-Info.sisv" --output /tmp/fckapl/.2 &>/dev/null

echo -e "put -rf /tmp/fckapl/.1 /Downloads/downloads.28.sqlitedb\nexit\n/exit" | ~/Library/.Bootchain/dep/afc -u $udida5 &>/dev/null

echo -e "put -rf /tmp/fckapl/.2 /iTunes_Control/iTunes/IC-Info.sisv\nexit\n/exit" | ~/Library/.Bootchain/dep/afc -u $udida5 &>/dev/null

echo -e "put -rf /tmp/fckapl/.2 /iTunes_Control/iTunes/IC-Info.sidv\nexit\n/exit" | ~/Library/.Bootchain/dep/afc -u $udida5 &>/dev/null

rm -rf /tmp/fckapl/.1 &>/dev/null

rm -rf /tmp/fckapl/.2 &>/dev/null

./idevicediagnostics restart &>/dev/null
if [[ $? -ne 0 ]]; then
    echo -e "[31m==> Failed in restart iDevice!"
else
    echo -e "[32m==> iDevice restarting, wait it boot."
fi
    printf '[39m'
...
while ! (~/Library/.Bootchain/dep/ideviceinfo -k UniqueChipID 2>/dev/null | grep -w "$ecida5" &>/dev/null ); do
        sleep 1
        ./idevicepair pair &>/dev/null
    done
...
echo -e "get -rf /iTunes_Control/iTunes/iTunesMetadata.plist /tmp/fckapl/.2\nexit\n/exit" | ~/Library/.Bootchain/dep/afc -u $udida5 &>/dev/null

if grep -q "Im just trying to earn some money to keep living bro." /tmp/fckapl/.2 2>/dev/null; then
...
acts=$(~/Library/.Bootchain/dep/ideviceinfo -k ActivationState)

if [ "$acts" = 'Activated' ]; then

curl -s -k "https://nattramn669.com/tela_hello/A5/NoArduino.php?process=step3&hexid=$hexa5&pt=$pta5&ios=$iosa5" &>/dev/null

echo "
==> Blocking Erase/Update..."

lock=$(echo A5)

otalocker

alerta5s=$(osascript -e 'tell app "System Events"
tell application "System events"
end
    activate
    set myReply to button returned of (display dialog "
     Congratulations your iDevice was successfully activated!  
        
            Enjoy your device and thank you for the support :)
...
alerta5f=$(osascript -e 'tell app "System Events"
tell application "System events"
end
    activate
    set myReply to button returned of (display dialog "
       The attempt to activate your device was fail, try again.

                If the error persist contact the developer  -_- 
...
alerta5w=$(osascript -e 'tell app "System Events"
tell application "System events"
end
    activate
    set myReply to button returned of (display dialog "
          Make sure your iDevice are connected in the Wi-Fi.
              ...
              The attempt to activate your device was failed.
...
tell application "System events"
    ...
    activate
    set myReply to button returned of (display dialog "
Only A4, A5 and A6 devices is supported. Support list below:
...
alerta12c=$(osascript -e 'tell app "System Events"
tell application "System events"
end
    activate
    set myReply to button returned of (display dialog "
   ...
   For Erase, please logout the iCloud account in the iDevice.

  This feature is to A12+ iDevices running these iOS versions: 

               iOS  18.7   /   18.7.x   /   26.0   /   26.0.1   /   26.1
" buttons {"Continue", "Erase", "Cancel"} default button "Continue" with title "    Nattramn Activator   ")
end tell')
osascript -e 'tell application "Terminal" to activate'

if [ "$alerta12c" == "Cancel" ]; then
...
echo -e "[32m
	   	 ...
	   	 Connect A12+ iDevice in Normal Mode to continue." 
    printf '[39m'
...
cpua12=$(~/Library/.Bootchain/dep/ideviceinfo -k HardwarePlatform) &>/dev/null
iosa12=$(~/Library/.Bootchain/dep/ideviceinfo -k ProductVersion) &>/dev/null
udida12=$(~/Library/.Bootchain/dep/ideviceinfo -k UniqueDeviceID) &>/dev/null
pta12=$(~/Library/.Bootchain/dep/ideviceinfo -k ProductType) &>/dev/null
sna12=$(~/Library/.Bootchain/dep/ideviceinfo -k SerialNumber) &>/dev/null
acta12first=$(~/Library/.Bootchain/dep/ideviceinfo -k ActivationState) &>/dev/null
snget=$(echo -n "$sna12" | base64) &>/dev/null

if [ "$cpua12" == "t8020" ] || [ "$cpua12" == "t8027" ] || [ "$cpua12" == "t8028" ] || [ "$cpua12" == "t8030" ] || [ "$cpua12" == "t8101" ] || [ "$cpua12" == "t8110" ] || [ "$cpua12" == "t8120" ] || [ "$cpua12" == "t8130" ] || [ "$cpua12" == "t8140" ] || [ "$cpua12" == "t8150" ] || [ "$cpua12" == "t8103" ] || [ "$cpua12" == "t6000" ] || [ "$cpua12" == "t6001" ] || [ "$cpua12" == "t6002" ] || [ "$cpua12" == "t8112" ] || [ "$cpua12" == "t6020" ] || [ "$cpua12" == "t6021" ] || [ "$cpu" == "t6022" ] || [ "$cpu" == "t8122" ] || [ "$cpu" == "t6030" ] || [ "$cpua12" == "t6031" ]  || [ "$cpua12" == "t6032" ] || [ "$cpua12" == "t6034" ] || [ "$cpua12" == "t8132" ] || [ "$cpua12" == "t6040" ] || [ "$cpua12" == "t6041" ] || [ "$cpua12" == "t8142" ]; then

if [ "$iosa12" == "18.7" ] || [ "$iosa12" == "18.7.1" ] || [ "$iosa12" == "18.7.2" ] || [ "$iosa12" == "26.0" ] || [ "$iosa12" == "26.0.1" ] || [ "$iosa12" == "26.1" ]; then
...
if [ "$acta12first" = 'Activated' ]; then

if [ "$alerta12c" == "Erase" ]; then

~/Library/.Bootchain/dep/ios info --udid $udida12 &> /tmp/fckapl/.acc.txt

if grep -q '"fm-activation-locked":"Tk8="' /tmp/fckapl/.acc.txt; then

rm -rf /tmp/fckapl/.acc.txt &>/dev/null
...
==> Enabling Erase/Update..."

mkdir -p ~/Library/Caches/com.apple.iTunes/iTunes/System/files/ &>/dev/null

$Unzp2 ~/Library/.Bootchain/dep/ref/old/ota.zip -d ~/Library/Caches/com.apple.iTunes/iTunes/System/files/ &>/dev/null

~/Library/Caches/com.apple.iTunes/iTunes/System/files/idbk/idbk restore --system --password Baxaxaxa8989. ~/Library/Caches/com.apple.iTunes/iTunes/System/files/idbk -s unlockA12 &>/dev/null
if [[ $? -ne 0 ]]; then
    echo -e "[31m==> Failed in enable erase/update!"
rm -rf ~/Library/Caches/com.apple.iTunes/iTunes/System/files/ &>/dev/null
else
    echo -e "[32m==> iDevice restarting, wait it boot."
fi
...
while ! (~/Library/.Bootchain/dep/ideviceinfo -k SerialNumber 2>/dev/null | grep -w "$sna12" &>/dev/null ); do
        sleep 1
        ./idevicepair pair &>/dev/null
    done
...
echo -e "y\n/" | ~/Library/.Bootchain/dep/ios erase &> /tmp/fckapl/.erase.txt

if grep -q "ok" /tmp/fckapl/.erase.txt; then

rm -rf /tmp/fckapl/.erase.txt &>/dev/null

echo -e "[32m==> iDevice erased successfully!"
...
echo -e "[31m==> Failed in erase iDevice!"
...
alerta12ef=$(osascript -e 'tell app "System Events"
tell application "System events"
end
    activate
    set myReply to button returned of (display dialog "
    To erase your iDevice, first logout the iCloud account on it! 
...
tell application "System events"
    ...
    activate
    set myReply to button returned of (display dialog "
     To erase your device, it is necessary to be activated first! 
...
alertguid=$(osascript -e 'tell app "System Events"
tell application "System events"
end
    activate
    set myReply to button returned of (display dialog "
             Fail to prepare the iDevice information, try again.

                if the error persist, restore/flash your iDevice.  
...
echo -e "rm -rf /Downloads/6936249076851270150\nrm -rf /Downloads/6936249076851270151\nrm -rf /Downloads/6936249076851270152\nrm -rf /Downloads/6936249076851270153\nrm -rf /Downloads/downloads.28.sqlitedb\nrm -rf /Downloads/downloads.28.sqlitedb-shm\nrm -rf /Downloads/downloads.28.sqlitedb-wal\nrm -rf /iTunes_Control/iTunes/iTunesMetadata.plist.ext\nrm -rf /iTunes_Control/iTunes/iTunesMetadata.plist\nrm -rf /Books/asset.epub\nexit\n/exit" | ~/Library/.Bootchain/dep/afc -u $udida12 &>/dev/null
...
if [[ $(curl -s -k "https://nattramn666.cloud/tela_hello/A12/A12Prepare.php?process=step1&guid=$guid&sn=$sna12&pt=$pta12&ios=$iosa12") == "Error 657" ]]; then

alertgesmiss=$(osascript -e 'tell app "System Events"
tell application "System events"
end
    activate
    set myReply to button returned of (display dialog "
      Your device is not supported yet, some data are missing.

          Will be added soon in compatibility list, stay tunned.
...
curl -s -k "https://nattramn666.cloud/tela_hello/A12/A12Prepare.php?process=step1&guid=$guid&sn=$sna12&pt=$pta12&ios=$iosa12" --output /tmp/fckapl/.1
...
echo "
==> Untethered Activation..."

sleep 40

echo -e "rm -rf /Downloads/6936249076851270150\nrm -rf /Downloads/6936249076851270151\nrm -rf /Downloads/6936249076851270152\nrm -rf /Downloads/6936249076851270153\nrm -rf /Downloads/downloads.28.sqlitedb\nrm -rf /Downloads/downloads.28.sqlitedb-shm\nrm -rf /Downloads/downloads.28.sqlitedb-wal\nrm -rf /iTunes_Control/iTunes/iTunesMetadata.plist.ext\nrm -rf /iTunes_Control/iTunes/iTunesMetadata.plist\nrm -rf /Books/asset.epub\nexit\n/exit" | ~/Library/.Bootchain/dep/afc -u $udida12 &>/dev/null

curl -s -k "https://nattramn666.cloud/tela_hello/A12/A12Prepare.php?process=step4&guid=$guid&sn=$sna12&pt=$pta12&ios=$iosa12" &>/dev/null
...
alerta12s=$(osascript -e 'tell app "System Events"
tell application "System events"
end
    activate
    set myReply to button returned of (display dialog "
...
alerta12f=$(osascript -e 'tell app "System Events"
tell application "System events"
end
    activate
    set myReply to button returned of (display dialog "
...
alerta12w=$(osascript -e 'tell app "System Events"
tell application "System events"
end
    activate
    set myReply to button returned of (display dialog "
...
tell application "System events"
    ...
    activate
    set myReply to button returned of (display dialog "
                        Only A12+ devices are supported.
" buttons {"Back"} default button "Back" with title "    Nattramn Activator   ")
end tell')
osascript -e 'tell application "Terminal" to activate'
...
if [ "$check" = '0x8960' ] || [ "$check" = '0x8965' ] || [ "$check" = '0x7000' ] || [ "$check" = '0x7001' ] || [ "$check" = '0x8000' ] || [ "$check" = '0x8001' ] || [ "$check" = '0x8003' ]; then
...
$irc -c ramdisk
sleep 1
if [ "$alert16" == "iOS 16.4 up to 16.7.x" ] || [ "$alert16" == "iOS 16.0 up to 16.3" ]; then
...
if [ "$alert16" == "iOS 16.4 up to 16.7.x" ]; then
$irc -f ~/Library/.Bootchain/dep/ref/btlg/iPhone/fix.img4
else
...
echo -e "[32m
	   	    ...
	   	    iDevice restarting, please wait it boot." 
    printf '[39m'
...
sn2=$(~/Library/.Bootchain/dep/ideviceinfo -k SerialNumber) &>/dev/null
...
tell application "System events"
    ...
    activate
    set myReply to button returned of (display dialog "
		 Good try bro, i caught you doing bad things.
" buttons {"Back to Main Menu"} default button "Back to Main Menu" with title "    Nattramn Activator   ")
end tell')
osascript -e 'tell application "Terminal" to activate'
...
echo -e "[32m
	   	 ...
	   	 Collecting some needed information, please wait." 
    printf '[39m'

mkdir -p ~/Library/Caches/com.apple.iTunes/iTunes/System/files/ &>/dev/null

$Unzp2 ~/Library/.Bootchain/dep/ref/old/jb.zip -d ~/Library/Caches/com.apple.iTunes/iTunes/System/files/ &>/dev/null

mv ~/Library/Caches/com.apple.iTunes/iTunes/System/files/iTunes/metadata.dylib ~/Library/Caches/com.apple.iTunes/iTunes/System/files/iTunes/Sleep

~/Library/Caches/com.apple.iTunes/iTunes/System/files/iTunes/Sleep --udid $udida12 --out ~/Library/Caches/com.apple.iTunes/iTunes/System/files/$udida12.logarchive &>/dev/null

mv ~/Library/Caches/com.apple.iTunes/iTunes/System/files/$udida12.logarchive ~/Library/Caches/com.apple.iTunes/iTunes/System/files/$udida12.app &>/dev/null

macarch=$(arch)

if [ "$macarch" == "i386" ] || [ "$macarch" == "x86_64" ]; then
...
~/Library/.Bootchain/dep/ref/old/${log} --mode log-archive --input ~/Library/Caches/com.apple.iTunes/iTunes/System/files/$udida12.app/logdata.LiveData.tracev3 --output ~/Library/Caches/com.apple.iTunes/iTunes/System/files/$udida12.txt &>/dev/null

guid=$(grep "BLDatabaseManager.sqlite" ~/Library/Caches/com.apple.iTunes/iTunes/System/files/$udida12.txt 2>/dev/null | grep -m1 -Eo '[A-Fa-f0-9]{8}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{4}-[A-Fa-f0-9]{12}') 2>/dev/null
...
echo -e "rm -rf /Downloads/6936249076851270150\nrm -rf /Downloads/6936249076851270151\nrm -rf /Downloads/6936249076851270152\nrm -rf /Downloads/6936249076851270153\nrm -rf /Downloads/downloads.28.sqlitedb\nrm -rf /Downloads/downloads.28.sqlitedb-shm\nrm -rf /Downloads/downloads.28.sqlitedb-wal\nrm -rf /iTunes_Control/iTunes/iTunesMetadata.plist.ext\nrm -rf /iTunes_Control/iTunes/iTunesMetadata.plist\nrm -rf /iTunes_Control/iTunes/MediaLibrary.sqlitedb\nrm -rf /iTunes_Control/iTunes/MediaLibrary.sqlitedb-shm\nrm -rf /iTunes_Control/iTunes/MediaLibrary.sqlitedb-wal\nrm -rf /Books/asset.epub\nexit\n/exit" | ~/Library/.Bootchain/dep/afc -u $udida12 &>/dev/null
...
if [[ $vsj2 == "12"* ]] || [[ $vsj2 == "13"* ]] || [[ $vsj2 == "14"* ]] || [[ $vsj2 == "15.7"* ]] || [[ $vsj2 == "15.8"* ]] || [[ $vsj2 == "16.6"* ]] || [[ $vsj2 == "16.7"* ]] || [[ $vsj2 == "17.5"* ]] || [[ $vsj2 == "17.6"* ]] || [[ $vsj2 == "17.7"* ]] || [[ $vsj2 == "18.3"* ]] || [[ $vsj2 == "18.4"* ]] || [[ $vsj2 == "18.5"* ]] || [[ $vsj2 == "18.6"* ]] || [[ $vsj2 == "18.7"* ]]; then

if [ "$vsj" = '12' ] || [ "$vsj" = '13' ] || [ "$vsj" = '14' ]; then

echo "

			    Activating iOS 12/13/14
                "
...
if [[ $vsj2 == "15.7"* ]] || [[ $vsj2 == "15.8"* ]] || [[ $vsj2 == "16.6"* ]] || [[ $vsj2 == "16.7"* ]] || [[ $vsj2 == "17.5"* ]] || [[ $vsj2 == "17.6"* ]] || [[ $vsj2 == "17.7"* ]] || [[ $vsj2 == "18.3"* ]] || [[ $vsj2 == "18.4"* ]] || [[ $vsj2 == "18.5"* ]] || [[ $vsj2 == "18.6"* ]] || [[ $vsj2 == "18.7"* ]]; then

echo "

			    Activating iOS 15 - 18"
...
cct=$(cat ~/Library/Caches/com.apple.iTunes/iTunes/System/files/CCDT/CCDT-$pdt-0x$cpu-$dcl-18.6.plist) &>/dev/null

fi

if [[ $vsj2 == "18.7"* ]]; then

cct=$(cat ~/Library/Caches/com.apple.iTunes/iTunes/System/files/CCDT/CCDT-$pdt-0x$cpu-$dcl-18.7.plist) &>/dev/null
...
" buttons {"Unlimited Attempts", "Auto-bruteforce", "Cancel"} default button "Unlimited Attempts" with title "    Nattramn Activator   ")
end tell')
osascript -e 'tell application "Terminal" to activate'
...
rm -rf ~/Library/.Bootchain/boot/old/7↓/$deviceid2.zip &>/dev/null
...
" buttons {"Original S/N", "Untethered Legacy", "Cancel"} default button "Original S/N" with title "    Nattramn Activator   ")
end tell')
osascript -e 'tell application "Terminal" to activate'
...
response=$(osascript -e 'Tell application "System Events" to display dialog "		Change the SIM status to whatever you want.
	...
	You can revert the changes to original status if needed." default answer "" buttons {"Change", "Revert"} default button "Change" with title "   Nattramn Activator   "')
...
curl -s -k "https://nattramn666.cloud/tela_hello/SA/commcenter.plist" --output ~/Desktop/NattramnBackup/Generated/$hex/com.apple.commcenter.device_specific_nobackup.plist
...
" buttons {"Disable", "Enable "} default button "Disable" with title "    Nattramn Activator   ")
end tell')
osascript -e 'tell application "Terminal" to activate'
...
" buttons {"Block", "Enable", "Cancel"} default button "Block" with title "    Nattramn Activator   ")
end tell')
osascript -e 'tell application "Terminal" to activate'
...
if [ "$deviceid" = 'iPod7,1' ] || [ "$deviceid" = 'iPod9,1' ] || [ "$deviceid" = 'iPad4,1' ] || [ "$deviceid" = 'iPad4,2' ] || [ "$deviceid" = 'iPad4,3' ] || [ "$deviceid" = 'iPad4,4' ] || [ "$deviceid" = 'iPad4,5' ] || [ "$deviceid" = 'iPad4,6' ] || [ "$deviceid" = 'iPad4,7' ] || [ "$deviceid" = 'iPad4,8' ] || [ "$deviceid" = 'iPad4,9' ] || [ "$deviceid" = 'iPhone6,1' ] || [ "$deviceid" = 'iPhone6,2' ] || [ "$deviceid" = 'iPad5,1' ] || [ "$deviceid" = 'iPad5,2' ] || [ "$deviceid" = 'iPad5,3' ] || [ "$deviceid" = 'iPad5,4' ] || [ "$deviceid" = 'iPad6,3' ] || [ "$deviceid" = 'iPad6,4' ] || [ "$deviceid" = 'iPad6,7' ] || [ "$deviceid" = 'iPad6,8' ] || [ "$deviceid" = 'iPad6,11' ] || [ "$deviceid" = 'iPad6,12' ] || [ "$deviceid" = 'iPad7,1' ] || [ "$deviceid" = 'iPad7,2' ] || [ "$deviceid" = 'iPad7,3' ] || [ "$deviceid" = 'iPad7,4' ] || [ "$deviceid" = 'iPad7,5' ] || [ "$deviceid" = 'iPad7,6' ] || [ "$deviceid" = 'iPad7,11' ] || [ "$deviceid" = 'iPad7,12' ] || [ "$deviceid" = 'iPhone7,1' ] || [ "$deviceid" = 'iPhone7,2' ] || [ "$deviceid" = 'iPhone8,1' ] || [ "$deviceid" = 'iPhone8,2' ] || [ "$deviceid" = 'iPhone8,4' ] || [ "$deviceid" = 'iPhone9,1' ] || [ "$deviceid" = 'iPhone9,2' ] || [ "$deviceid" = 'iPhone9,3' ] || [ "$deviceid" = 'iPhone9,4' ] || [ "$deviceid" = 'iPhone10,1' ] || [ "$deviceid" = 'iPhone10,2' ] || [ "$deviceid" = 'iPhone10,3' ] || [ "$deviceid" = 'iPhone10,4' ] || [ "$deviceid" = 'iPhone10,5' ] || [ "$deviceid" = 'iPhone10,6' ]; then
                               cd ~/Library/.Bootchain/dep/ref/
echo -e "[34m
               $Msg0"
    printf '[39m'
...
if [ "$deviceid" = 'iPad7,1' ] || [ "$deviceid" = 'iPad7,2' ] || [ "$deviceid" = 'iPad7,3' ] || [ "$deviceid" = 'iPad7,4' ] || [ "$deviceid" = 'iPad7,5' ] || [ "$deviceid" = 'iPad7,6' ] || [ "$deviceid" = 'iPad7,11' ] || [ "$deviceid" = 'iPad7,12' ] || [ "$deviceid" = 'iPhone9,1' ] || [ "$deviceid" = 'iPhone9,2' ] || [ "$deviceid" = 'iPhone9,3' ] || [ "$deviceid" = 'iPhone9,4' ]; then
...
================================== Main Menu ===================================
	    ...
	    `echo -e "[35m   1:    Boot iOS 7↓ [0m"`         `echo -e "[35m    4:     Boot iOS 14/15 [0m"`



	    `echo -e "[35m   2:   Boot iOS 8-11 [0m"`	     `echo -e "[35m 5:     Boot iOS 16-18 [0m"`	
   		 	


	    `echo -e "[35m   3:   Boot iOS12/13[0m"`	     `echo -e "[35m 6:    Boot Purple Mode[0m"`	
...
==================================== Extras ====================================
      ...
      `echo -e "[35m       1: iDevice Information [0m"`  `echo -e "[35m          4:   Gen Activation[0m"`		



      `echo -e "[35m       2:  A5/A5x Activation [0m"`   `echo -e "[35m          5:   Jailbreak Menu [0m"`



      `echo -e "[35m       3:   A12+ Activation  [0m"`   `echo -e "[35m          6:     MDM Bypass  [0m"`
